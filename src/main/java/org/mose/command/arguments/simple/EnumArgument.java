...
public record EnumArgument<E extends Enum<?>>(@NotNull String id,
    ...
    @Override
    public @NotNull
    CommandArgumentResult<E> parse(@NotNull CommandContext context, @NotNull CommandArgumentContext<E> argument) throws IOException {
    ...
    @Override
    public @NotNull
    Set<String> suggest(@NotNull CommandContext commandContext, @NotNull CommandArgumentContext<E> argument) {
