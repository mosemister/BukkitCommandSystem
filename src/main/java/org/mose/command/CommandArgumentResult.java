...
public record CommandArgumentResult<T>(int position, T value) {
    ...
    /**
     * Constructor
     * @param position The new index of the command argument to process
     * @param value the object of the resulting argument
     */
     ...
     * @return The CommandArgumentResult
     */
    public static @NotNull <T> CommandArgumentResult<T> from(CommandArgumentContext<T> argumentContext, int length, T value) {
